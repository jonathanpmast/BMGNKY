...
:: 4. Run DNU Bundle
call %DNX_RUNTIME%\bin\dnu publish "D:\home\site\repository\BizManWeb\project.json" --runtime %DNX_RUNTIME% --out "%DEPLOYMENT_TEMP%" %SCM_DNU_PUBLISH_OPTIONS%
IF !ERRORLEVEL! NEQ 0 goto error
...
call cd BizManWeb
call %DNX_RUNTIME%\bin\dnx ef database update -e %ASPNET_ENV% -v
IF !ERRORLEVEL! NEQ 0 goto error
